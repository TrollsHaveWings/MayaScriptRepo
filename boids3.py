# boids3.py - makes a number of instances of spheres with random position and velocity
# Moves all the spheres with constant velocity for each keyframe. Spheres leave the bounding box.
